...
namespace OOP
{
    public partial class frmMain : Form
    {
        ...
        private void LoadDataIntoDgvQuanLyMuonSach()
        {
            MySqlConnection connection = tao_connetion();
            connection.Open();
            string query = "SELECT * FROM borrow_bill";
            MySqlCommand cmd = new MySqlCommand(query, connection);
        ...
        // Quản lý sách: gồm các chức năng thêm, xóa, sửa, tìm kiếm
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection connection = tao_connetion();
            connection.Open();
            string insertQuery = "INSERT INTO book (Book_ID, Book_Category, Book_Au, Book_Name, Book_Language) VALUES (@IDSach, @TheLoai, @TacGia, @TenSach, @NgonNgu)";
        ...
        private void btnTimKiemSach_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                string query = "select * from book WHERE Book_ID = @IDSach";
                MySqlCommand cmd = new MySqlCommand(query, connection);
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                string deleteQuery = "delete from book where Book_ID = @IDSach";
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            string query = "select * from CardReader WHERE Reader_ID = @MaDocGia and CardReader_ID = @MaThe and Reader_Name = @TenDocGia and Reader_Dob = @NgaySinh";
            MySqlCommand cmd = new MySqlCommand(query, connection);
        ...
        private void btnDangKy_Click(object sender, EventArgs e)
        {
            ...
            string insertQuery = "INSERT INTO CardReader (CardReader_ID, Reader_ID, Reader_Name, Reader_Dob) VALUES (@MaThe, @MaDocGia, @TenDocGia, @NgaySinh)";
            MySqlCommand insertCmd = new MySqlCommand(insertQuery, connection);
        ...
        private void btnXoaQLTD_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                string deleteQuery = "delete from CardReader where CardReader_ID = @MaThe and Reader_ID = @MaDocGia and Reader_Name = @TenDocGia and Reader_Dob = @NgaySinh";
                MySqlCommand deleteCmd = new MySqlCommand(deleteQuery, connection);
        ...
        private void btnThemQLNS_Click(object sender, EventArgs e)
        {
            ...
            string queryexist = "select count(*) from staff where staff_id = @StaffID";
            MySqlCommand existcmd = new MySqlCommand(queryexist, connection);
            ...
            if (count > 0)
            {
                ...
                string selectAllQuery1 = "SELECT * FROM Book";
                ...
                string insertQuery = "INSERT INTO Import_Bill (Import_Bill_ID, Import_Bill_Date, Staff_ID, Book_ID) VALUES (@MaBillNhap, @NgayNhap, @MaNhanVien, @MaSach)";
                MySqlCommand insertCmd = new MySqlCommand(insertQuery, connection);
                ...
                // Hiển thị toàn bộ dữ liệu trong DataGridView sau khi thêm mới
                string selectAllQuery = "SELECT * FROM Import_Bill";
                MySqlCommand selectAllCmd = new MySqlCommand(selectAllQuery, connection);
                MySqlDataAdapter adapter = new MySqlDataAdapter(selectAllCmd);
                DataTable dataTable = new DataTable();
                adapter.Fill(dataTable);
        ...
        private void btnXoaQLNS_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                string deleteQuery = "delete from Import_Bill where Import_Bill_ID = @MaBillNhap and Book_ID = @MaSach";
                MySqlCommand deleteCmd = new MySqlCommand(deleteQuery, connection);
        ...
        private void btnTimKiemQLNS_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                string query = "select * from Import_Bill WHERE Import_Bill_ID = @MaBillNhap or Staff_ID = @MaNhanVien or Book_ID = @MaSach";
                MySqlCommand cmd = new MySqlCommand(query, connection);
        ...
        private void btnThemQLMS_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                string insertQuery = "INSERT INTO Borrow_Bill (Borrow_Bill_ID, Borrow_Bill_Date, Reader_ID, Book_ID, CardReader_ID, Reader_Name) VALUES (@MaBillMuon, @NgayMuon, @MaDocGia, @MaSach, @MaTheDoc, @TenDocGia)";
                MySqlCommand insertCmd = new MySqlCommand(insertQuery, connection);
        ...
        private void btnXoaQLMS_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                string deleteQuery = "delete from Borrow_Bill where Borrow_Bill_ID = @MaBillMuon or Reader_ID = @MaDocGia or Book_ID = @MaSach and CardReader_ID = @MaThe";
                MySqlCommand deleteCmd = new MySqlCommand(deleteQuery, connection);
